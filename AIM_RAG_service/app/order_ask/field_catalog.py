...
FILTERABLE_FIELDS_JSON: Dict[str, Any] = {
    ...
    "fields": [
        ...
        {
            "key": "outstatus",
            "aliases": ["outsource status", "out status", "order outsource status"],
            "db_fields": ["outstatus", "outsourcedetails.outStatus"],
            "values": ["Open", "Planned", "Assigned", "Quoted", "Delivered"],
            "example_questions": [
                "outsource assigned orders",
                "how many planned outsource orders",
            ],
        },
        {
            "key": "accountingstatus",
            "aliases": ["accounting status", "account status"],
            "db_fields": ["accountingstatus"],
            "values": ["Invoiced", "PartiallyPaid", "Paid", "Restricted"],
            "example_questions": [
                "invoiced orders",
                "how many paid orders",
                "partially paid orders",
                "invoice restricted orders",
            ],
        },
        {
            "key": "pin",
